...
/* External objects */
extern arrow_int line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
arrow_void printScannerError(arrow_char* fmt, ...);
arrow_void displayScanner(BufferReader* ptrBuffer);
arrow_int getScannerFilesize(arrow_char* fname);
